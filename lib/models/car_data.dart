class CarData {
  static final Map<String, Map<String, List<int>>> carMakeModelYears = {
    'Chevrolet': {
      'Optra': [2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2025],
    ...
    'Hyundai': {
      ...
      'Tucson': [2019, 2020, 2021, 2022, 2023],
      'Elantra AD': [2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025],
      'Elantra CN7': [2021, 2022, 2023],
    },
    'Nissan': {
    ...
    'Renault': {
      'Megane': [2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020],
      'Logan': [2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021],
      'Fluence': [2010, 2011, 2012, 2013, 2014, 2015, 2016],
    },
    'Toyota': {
