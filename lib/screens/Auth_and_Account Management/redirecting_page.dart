            ...
            if (!snapshot.hasData || snapshot.data == null) {
              ...
              return FutureBuilder<DocumentSnapshot>(
                  ...
                  builder: (context, userSnaphot) {
                    if (userSnaphot.connectionState ==
                        ConnectionState.waiting) {
                      return const Scaffold(
                          body: Center(child: CircularProgressIndicator()));
                    } else if (userSnaphot.hasData &&
                        userSnaphot.data!.exists) {
                      final userData =
                          userSnaphot.data!.data() as Map<String, dynamic>;
                      ...
                      return FutureBuilder<DocumentSnapshot>(
                          ...
                          builder: (context, sellersnapshot) {
                            if (sellersnapshot.connectionState ==
                              ...
                              if (sellerData['seller_data_completed'] ==
                                  false) {
                                return EnterSellerData();
                              } else if (sellerData['store_verified'] ==
                                  false) {
