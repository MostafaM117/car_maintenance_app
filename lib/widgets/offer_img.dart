...
class OfferImg extends StatefulWidget {
  const OfferImg({super.key, required this.onImageUploaded});
  final Function(String) onImageUploaded;

  @override
  _OfferImgState createState() => _OfferImgState();
}

class _OfferImgState extends State<OfferImg> {
  String? imageUrl;
  File? _image;
